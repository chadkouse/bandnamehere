...
export const IntroContent = () => (
  <>
    ...
    <p>
      By the way, check out our <a href="/events" className="border-b border-dotted border-white/50">tour schedule</a>.
    </p>
  </>
);
...
export const EventsContent = () => (
  <>
    ...
    <p>
      ...
      <a href="/contact" className="border-b border-dotted border-white/50">Contact Us</a> and we&apos;ll
  ...
  <>
    ...
    <ul className="flex gap-3 list-none pl-0">
      <li>
        <a
          href="https://www.facebook.com/partypunchband"
          className="inline-flex items-center justify-center w-9 h-9 rounded-full border border-white hover:bg-white/10 active:bg-white/20 transition-colors text-color"
          aria-label="Facebook"
        >
          <FaFacebook size={18} />
          <span className="sr-only">Facebook</span>
