      ...
      <span className="bg-white inline-block h-8 sm:h-14 w-px">&nbsp;</span>
        ...
        >
          {[
            ...
            <li
              key={item.id}
              className={`flex items-center justify-center pl-0 sm:min-w-36 transition-colors border-t sm:border-t-0 first:border-t-0 ${index > 0 ? 'sm:border-l' : ''}`}
              style={{
            ...
            >
              <button
                ...
                className="sm:min-w-30 h-12 sm:h-11 uppercase text-sm hover:bg-(--color-border-bg) active:bg-(--color-border-bg-alt) transition-colors w-full min-w-0 border-0 bg-transparent cursor-pointer text-white"
                style={{
