...
export const IntroContent = () => (
  <>
    ...
    <p>
      By the way, check out our <a href="/events" className="border-b border-dotted border-[var(--color-fg-light)]">tour schedule</a>.
    </p>
  </>
);
...
export const EventsContent = () => (
  <>
    ...
    <p>
      ...
      <a href="/contact" className="border-b border-dotted border-[var(--color-fg-light)]">Contact Us</a> and we&apos;ll
...
export const AboutContent = () => (
  <div className="flex flex-col gap-y-4">
    ...
    <ul className="flex gap-3 list-none pl-0">
      <li>
        <a
          ...
          className="inline-flex items-center justify-center w-9 h-9 rounded-full border border-white hover:bg-white/10 active:bg-white/20 transition-colors"
          aria-label="Facebook"
    ...
    <div>
      Check us out on{' '}
      <a href="https://facebook.com/partypunchband" className="border-b border-dotted">The Facebook</a> or{' '}
      <a href="https://instagram.com/partypunchband" className="border-b border-dotted">Instagram</a> for more!
    </div>
  </div>
);
...
export const ContactContent = () => (
  <>
    <p>
      Please find us on{' '}
      <a href="https://www.facebook.com/partypunchband" className="border-b border-dotted">The Facebook</a>
    </p>
    <ul className="flex gap-3 list-none pl-0">
      <li>
        <a
...
export const PromoContent = () => (
  <>
    ...
    <p>
      ...
      <Image src="/images/party_punch_color_logo_thumb.png" alt="Color Logo" width={100} height={100} /><br />
      <a href="/images/party_punch_color_logo.png" download>PNG Version</a>
    </p>
    <p>
      Color with transparent background<br />
      <Image src="/images/party_punch_logo_color_thumb.png" alt="Color Logo Transparent" width={100} height={100} /><br />
    ...
    <p>
      ...
      <Image src="/images/party_punch_logo_one_color_thumb.png" alt="One Color Logo" width={100} height={100} /><br />
